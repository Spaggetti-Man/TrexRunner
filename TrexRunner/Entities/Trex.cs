...
namespace TrexRunner.Entities
{
    public class Trex : IGameEntity
    {
        ...
        private const int TREX_IDLE_BACKGROUND_SPRITE_POSS_X = 40;
        private const int TREX_IDLE_BACKGROUND_SPRITE_POSS_Y = 0;
        ...
        private void CreateBlinkAnimation()
        {
            ...
            _blinkAnimation.AddFrame(_idleSprite, (float)blinkTimestamp + 0.5f);
